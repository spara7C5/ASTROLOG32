...
#define ST_WINDOW_NAME						szAppNameCore " verze " szVersionCore \
	" pro MS Windows (32 bit)"
#define ST_WITH_SWISS_EPHEMERIS				" se švýcarskými efemeridy v. " szSwissEphemerisVersion
...
#define ST_FILE_NOT_FOUND					"Soubor '%s' nenalezen v adresáøi'%s'"
#define ST_BUILT_ON							szAppNameCore " version " szVersionCore \
	" was built on %s by António Ramos."
#define ST_ENTER_CHART_INFO					"Vložte data pro horoskop è. %d" 
...
#define ST_OPEN_MAIN_CHART					"Otevøít hlavní horoskop"
#define ST_OPEN_CHART						"Open Chart #%d"
#define ST_SAVE_MAIN_CHART_DATA				"Uložit data hlavního horoskopu"
...
#define ST_WARNING_NOT_ALL_PLACES_SHOWN		">> POZOR - NEBYLA VYPSÁNA VŠECHNA MÍSTA. ZPØESNÌTE VYHLEDÁVACÍ KRITERIUM. <<" 
#define ST_NO_PLACE_MATCHING_REQUIREMENTS	">> Nebylo nalezeno žádné odpovídající místo <<"
#define ST_NEED_CHOOSE_ATLAS_BEFORE_SEARCH	"Pøed vyhledáváním je tøeba zvolit atlas"
#define ST_INT_VALUE_NOT_VALID_SETTING		"Hodnota %d není platné nastavení pro %s"
#define ST_FLOAT_VALUE_NOT_VALID_SETTING	"Hodnota %f není platné nastavení pro %s"
...
#define ST_HOUSE1							"dùm"
#define ST_HOUSES1							"%s domy."
#define ST_TROPICAL							"Tropický"
#define ST_SIDEREAL							"Siderický"
#define ST_SIDEREAL_TIME					"Siderický èas: %s"
#define ST_HELIOCENTRIC						"Heliocentric"
#define ST_GEOCENTRIC						"Geocentrický"
#define ST_JULIAN_DAY						"Julian. den: "
#define ST_HARMONIC							"Harmonic"
#define ST_OBLIQUITY						"Obliquita"
#define ST_BONUS_MODE						"Bonus Mode"
#define ST_INNER_RING						"Vnitøní kružnice:"
#define ST_OUTER_RING						"Vnìjší kružnice:"
...
#define ST_FIRE_EARTH						"Oheò  : %d, Zemì : %d,"
#define ST_AIR_WATER						"Vzduch: %d, Voda : %d"
#define ST_CAR_FIX_MUT						"Kar: %d, Pev: %d, Pro: %d"
#define ST_YANG_YIN							"Yang: %d, Yin: %d"
#define ST_M_N_A_D							"M: %d, I: %d, A: %d, D: %d"
#define ST_ANG_SUC_CAD						"Ang: %d, Suk: %d, Kad: %d"
#define ST_LEARN_SHARE						"Uèení: %d, Sdílení: %d"
